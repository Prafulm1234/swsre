...
- Update close-issues.yml ([#3031](https://github.com/axios/axios/pull/3031))
  - Update close-issues.yml
    Update close message to read better ð
...
- Gustavo LÃ³pez <gualopezb@gmail.com>
...
- Kamil PosiadaÅa <3dcreator.pl@gmail.com>
- Lukas Drgon <lukas.drgon@gmail.com>
- marcinx <mail@marcinx.com>
- Martti Laine <martti@codeclown.net>
- MichaÅ Zarach <michal.m.zarach@gmail.com>
...
- Fixing Vulnerability A Fortify Scan finds a critical Cross-Site Scripâ¦ ([#2451](https://github.com/axios/axios/pull/2451))
...
- ðFix request finally documentation in README ([#2189](https://github.com/axios/axios/pull/2189))
...
- Add r2curl in ECOSYSTEM ([#2141](https://github.com/axios/axios/pull/2141)) - ì ì©ì° / CX
...
- ascott18
- Benedikt RÃ¶tsch <axe312ger@users.noreply.github.com>
