...
assert.strictEqual(Buffer.from('aaaa').indexOf('ä½ å¥½', 'ucs2'), -1);
...
// ä½ å¥½ expands to a total of 6 bytes using UTF-8 and 4 bytes using UTF-16
assert.strictEqual(buf_bc.lastIndexOf('ä½ å¥½', 'ucs2'), -1);
assert.strictEqual(buf_bc.lastIndexOf('ä½ å¥½', 'utf8'), -1);
assert.strictEqual(buf_bc.lastIndexOf('ä½ å¥½', 'latin1'), -1);
assert.strictEqual(buf_bc.lastIndexOf('ä½ å¥½', 'binary'), -1);
assert.strictEqual(buf_bc.lastIndexOf(Buffer.from('ä½ å¥½')), -1);
assert.strictEqual(buf_bc.lastIndexOf('ä½ å¥½', 2, 'ucs2'), -1);
assert.strictEqual(buf_bc.lastIndexOf('ä½ å¥½', 3, 'utf8'), -1);
assert.strictEqual(buf_bc.lastIndexOf('ä½ å¥½', 5, 'latin1'), -1);
assert.strictEqual(buf_bc.lastIndexOf('ä½ å¥½', 5, 'binary'), -1);
assert.strictEqual(buf_bc.lastIndexOf(Buffer.from('ä½ å¥½'), 7), -1);
...
assert.strictEqual(-1, Buffer.from('ÂµaaaaÂ¶bbbb', 'latin1').lastIndexOf('Âµ'));
assert.strictEqual(-1, Buffer.from('ÂµaaaaÂ¶bbbb', 'binary').lastIndexOf('Âµ'));
