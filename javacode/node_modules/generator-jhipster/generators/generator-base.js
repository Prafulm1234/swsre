...
module.exports = class JHipsterBaseGenerator extends PrivateBase {
  ...
  printJHipsterLogo() {
    this.log('\n');
    this.log(`${chalk.green('        âââ')}${chalk.red(' âââ   âââ âââââââââ ââââââââ   âââââââ âââââââââ âââââââââ ââââââââ')}`);
    this.log(`${chalk.green('        âââ')}${chalk.red(' âââ   âââ âââââââââ âââââââââ ââââââââ âââââââââ âââââââââ âââââââââ')}`);
    this.log(`${chalk.green('        âââ')}${chalk.red(' âââââââââ    âââ    âââââââââ âââââââ     âââ    âââââââ   âââââââââ')}`);
    this.log(`${chalk.green('  âââ   âââ')}${chalk.red(' âââââââââ    âââ    ââââââââ   âââââââ    âââ    âââââââ   ââââââââ')}`);
    this.log(`${chalk.green('  âââââââââ')}${chalk.red(' âââ   âââ âââââââââ âââ       ââââââââ    âââ    âââââââââ âââ  ââââ')}`);
    this.log(`${chalk.green('   âââââââ ')}${chalk.red(' âââ   âââ âââââââââ âââ       âââââââ     âââ    âââââââââ âââ   âââ')}\n`);
    this.log(chalk.white.bold('                            https://www.jhipster.tech\n'));
    this.log(chalk.white('Welcome to JHipster ') + chalk.yellow(`v${packagejs.version}`));
    this.log(chalk.white(`Application files will be generated in folder: ${chalk.yellow(process.cwd())}`));
    if (process.cwd() === this.getUserHome()) {
      this.log(chalk.red.bold('\nï¸â ï¸  WARNING â ï¸  You are in your HOME folder!'));
