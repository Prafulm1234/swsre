...
const LANGUAGES = [
  ...
  {
    name: 'Armenian',
    dispName: 'ÕÕ¡ÕµÕ¥ÖÕ¥Õ¶',
    value: 'hy',
    dayjsLocaleId: 'hy-am',
  },
  {
    name: 'Belarusian',
    dispName: 'ÐÐµÐ»Ð°ÑÑÑÐºÑ',
    value: 'by',
    dayjsLocaleId: 'be',
    localeId: 'be',
  },
  ...
  { name: 'Bulgarian', dispName: 'ÐÑÐ»Ð³Ð°ÑÑÐºÐ¸', value: 'bg' },
  {
    name: 'Catalan',
    dispName: 'CatalÃ ',
    value: 'ca',
  ...
  { name: 'Czech', dispName: 'ÄeskÃ½', value: 'cs' },
  ...
  { name: 'French', dispName: 'FranÃ§ais', value: 'fr' },
  { name: 'Galician', dispName: 'Galego', value: 'gl' },
  { name: 'German', dispName: 'Deutsch', value: 'de' },
  { name: 'Greek', dispName: 'ÎÎ»Î»Î·Î½Î¹ÎºÎ¬', value: 'el' },
  { name: 'Hindi', dispName: 'à¤¹à¤¿à¤à¤¦à¥', value: 'hi' },
  ...
  { name: 'Japanese', dispName: 'æ¥æ¬èª', value: 'ja' },
  { name: 'Korean', dispName: 'íêµ­ì´', value: 'ko' },
  { name: 'Marathi', dispName: 'à¤®à¤°à¤¾à¤ à¥', value: 'mr' },
  { name: 'Myanmar', dispName: 'áá¼ááºáá¬', value: 'my' },
  { name: 'Polish', dispName: 'Polski', value: 'pl' },
  {
    name: 'Portuguese (Brazilian)',
    dispName: 'PortuguÃªs (Brasil)',
    value: 'pt-br',
    localeId: 'pt',
  },
  {
  ...
  { name: 'Romanian', dispName: 'RomÃ¢nÄ', value: 'ro' },
  { name: 'Russian', dispName: 'Ð ÑÑÑÐºÐ¸Ð¹', value: 'ru' },
  { name: 'Slovak', dispName: 'SlovenskÃ½', value: 'sk' },
  { name: 'Serbian', dispName: 'Srpski', value: 'sr' },
  { name: 'Sinhala', dispName: 'à·à·à¶à·à¶½', value: 'si' },
  { name: 'Spanish', dispName: 'EspaÃ±ol', value: 'es' },
  { name: 'Swedish', dispName: 'Svenska', value: 'sv' },
  { name: 'Turkish', dispName: 'TÃ¼rkÃ§e', value: 'tr' },
  { name: 'Tamil', dispName: 'à®¤à®®à®¿à®´à¯', value: 'ta' },
  { name: 'Telugu', dispName: 'à°¤à±à°²à±à°à±', value: 'te' },
  { name: 'Thai', dispName: 'à¹à¸à¸¢', value: 'th' },
  {
    name: 'Ukrainian',
    dispName: 'Ð£ÐºÑÐ°ÑÐ½ÑÑÐºÐ°',
    value: 'ua',
    localeId: 'uk',
    dayjsLocaleId: 'uk',
  },
  ...
  { name: 'Vietnamese', dispName: 'Tiáº¿ng Viá»t', value: 'vi' },
];
