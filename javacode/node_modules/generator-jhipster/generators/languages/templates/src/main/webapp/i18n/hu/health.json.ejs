...
{
    "health": {
        "title": "Rendszer ellenÅrzÃ©sek",
        "refresh.button": "FrissÃ­tÃ©s",
        ...
        "indicator": {
            ...
            "db": "AdatbÃ¡zis"<% } %><% if (databaseType === 'sql' && reactive) { %>,
            "r2dbc": "AdatbÃ¡zis"<% } %><% if (databaseType === 'mongodb') { %>,
