...
-%>
{
        ...
        "messages": {
            ...
            "validate": {
                "newpassword": {
                    ...
                    "maxlength": "La password non puÃ² contenere piÃ¹ di 50 caratteri",
                    "strength": "Robustezza della password:"
                },
                "confirmpassword": {
                    "required": "La password di conferma Ã¨ obbligatoria.",
                    "minlength": "La tua password deve essere di almeno 4 caratteri",
                    "maxlength": "La tua password non puÃ² contenere piÃ¹ di 50 caratteri"
                },
                "email": {
                    "required": "L'indirizzo email Ã¨ obbligatorio.",
                    "invalid": "L'indirizzo email non Ã¨ valido.",
                    "minlength": "L'indirizzo email deve essere di almeno 5 caratteri",
                    "maxlength": "L'indirizzo email non puÃ² contenere piÃ¹ di 50 caratteri"
                }
            }
        },
        "field": {
    ...
    "entity": {
        ...
        "validation": {
            ...
            "maxlength": "Questo campo non puÃ² essere piÃ¹ di {{ max }} caratteri.",
            "min": "Questo campo dovrebbe essere piÃ¹ di {{ min }}.",
            "max": "Questo campo non puÃ² essere superiore a {{ max }}.",
            "minbytes": "Questo campo dovrebbe essere piÃ¹ di {{ min }} byte.",
            "maxbytes": "Questo campo non puÃ² essere superiore a {{ max }} byte.",
    ...
    "error": {
        ...
        "NotNull": "Il campo {{ fieldName }} non puÃ² essere vuoto!",
        "Size": "Il campo {{ fieldName }} non Ã¨ conforme ai requisiti di lunghezza min/max!",
        "userexists": "Il nome utente Ã¨ giÃ  in uso!",
        "emailexists": "L'email Ã¨ giÃ  in uso!",
        "idexists": "Un(a) nuovo/a {{entityName}} non puÃ² giÃ  avere un ID",
        "idnull": "Invalid ID",
