...
{
    "health": {
        "title": "Starea aplicaÈiei",
        "refresh.button": "ReÃ®ncÄrcare",
        "stacktrace": "Stacktrace",
        "details": {
            "details": "Detalii",
            "properties": "ProprietÄÈi",
            "name": "Nume",
            "value": "Valoare",
            "error": "Eroare"
        },
        "indicator": {
            ...
            "db": "BazÄ de date"<% } %><% if (databaseType === 'sql' && reactive) { %>,
            "r2dbc": "BazÄ de date"<% } %><% if (databaseType === 'mongodb') { %>,
