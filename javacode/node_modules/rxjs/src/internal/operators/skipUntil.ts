 ...
 *
 * The `skipUntil` operator causes the observable stream to skip the emission of values ââuntil the passed in observable emits the first value.
 ...
 * ## Example
 *
 * In the following example, all emitted values ââof the interval observable are skipped until the user clicks anywhere within the page.
 *
 * ```ts
