...
-   Add `xaml`
    -   Thanks to [Kaan Barmore-GenÃ§](https://github.com/SeriousBug) for [pull request #207](https://github.com/bevry/textextensions/pull/207)
...
-   Add `wxml`
    -   Thanks to [åç¥º](https://github.com/gucong3000) for [istextorbinary issue #9](https://github.com/bevry/istextorbinary/issues/9)
